import { Assembler, Registers } from './assembler.js'
...
const aligned_alloc = wrap(handle, ffast.aligned_alloc, 2)
...
const {
  mprotect, munmap, memfd_create, bind_fastcall,
  ...
  madvise, MADV_HUGEPAGE, sleep, usleep, utf8_decode, latin1_decode, strnlen,
  read_memory, utf8_length
} = ffast
...
export {
  dlopen, dlsym, memcpy, mmap, wrap, assert, ptr, aligned_alloc,
  mprotect, munmap, memfd_create, bind_fastcall,
  ...
  asm, compiler, madvise, MADV_HUGEPAGE, sleep, addr, usleep, colors, cstr,
